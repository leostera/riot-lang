...
//!
//! **Note**: For FFI usage with derive macros, use the `raml-ffi` crate instead, which
//! re-exports everything from `raml-core` plus provides `#[derive(Value)]`.
//!
...
//!
//! ```
//! use raml_core::{Block, BlockHeader, GcColor, Tag};
//!
