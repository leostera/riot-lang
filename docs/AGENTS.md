...
3. Use historical cleanup language only when the document is specifically about a migration.
4. Snapshot RFDs are historical records of the system at the time they were written. Write a new snapshot RFD when later behavior has changed enough to warrant one.
...
6. Preserve the existing voice of each document.

## Review

1. Read edited markdown for tone and structure.
