...
4. When architecture or package boundaries change, update the affected RFDs in the same change.
5. Preserve the existing voice of a document instead of normalizing everything to contributor docs.
