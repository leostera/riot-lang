...
let tests = [
  Test.case "parquet metadata roundtrips" test_roundtrips_metadata;
  Test.case "parquet metadata preserves unknown enum values" test_preserves_unknown_enum_values;
  Test.case "parquet metadata rejects trailing bytes" test_rejects_trailing_metadata_bytes;
]
