...
module Handler = struct
  ...
  type t = H : (module Intf with type args = 'a and type state = 'b) * 'b -> t

  let make (type a b) (module I : Intf with type args = a and type state = b)
      (args : a) : t =
  ...
  let handle_message (H ((module I), state)) msg conn =
