...
module Status = struct
  ...
  let init = fun _conn () ->
    let timer =
      Timer.send_interval (self ()) ~interval:(Time.Duration.from_secs 1) (TimerTick Refresh)
    in
                ...
                div
                  ...
                  [
                    ...
                    p
                      [
                        text
                          "Each component is independent with its own state and WebSocket connection";
                      ];
                  ];
                div
                  ...
                  [
                    ...
                    p
                      [
                        ...
                        text
                          "Events are sent to the server, which updates state and sends back HTML patches.";
                      ];
                    p
                      [
                        strong [ text "Status: " ];
                        text
                          "Server timestamp rendering. Click the button to get the current server time. ";
                    ...
                    p
                      [
                        ...
                        text
                          "Have independent state, separate WebSocket connections, and update without affecting each other!";
                      ];
                  ];
              ];
          ];
