  ...
  let progress = fun ?(value = 0) ?(max = 100) () ->
    ...
    [
      ...
      ~attrs:[
        class_ "progress-bar";
        style_
        ("background: " ^ primary_color ^ "; height: 100%; width: " ^ Float.to_string percentage ^ "%; transition: width 0.3s;");
    ...
    [
      ...
      [
        ...
        [
          ...
          ~attrs:[
            style_
            ("margin-top: " ^ MyDesign.spacing_xl ^ "; padding-top: " ^ MyDesign.spacing_lg ^ "; border-top: 1px solid #ddd; text-align: center;");

          ]
          [
            p
            [ text "Built with "; strong [ text "Suri.Component" ]; text " design system pattern";  ];
