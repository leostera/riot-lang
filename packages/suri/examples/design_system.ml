...
module MyDesign = struct
  ...
  let alert ?(type_ = "info") ?(dismissible = false) children =
    let (bg_color, border_color, text_color) = match type_ with
...
let product_card ~name ~price ~in_stock ~discount =
    ...
    MyDesign.stack ~spacing:MyDesign.spacing_md [
      div [
        ...
        MyDesign.row ~spacing:MyDesign.spacing_sm ~align:"center" [
          ...
          when_ (discount > 0) (
            MyDesign.badge ~variant:"warning" 
              ((Int.to_string discount) ^ "% OFF")
          );
        ];
      ];
      ...
      MyDesign.container [
        MyDesign.stack ~spacing:MyDesign.spacing_xl [
          ...
          section [
            h2 [text "Alerts"];
            MyDesign.stack ~spacing:MyDesign.spacing_md [
              MyDesign.alert ~type_:"info" [
                strong [text "Info: "];
                text "This is an informational message.";
              ];
              MyDesign.alert ~type_:"success" ~dismissible:true [
                strong [text "Success! "];
                text "Your changes have been saved.";
              ];
              MyDesign.alert ~type_:"warning" [
                strong [text "Warning: "];
                text "Please review your settings.";
              ];
              MyDesign.alert ~type_:"danger" [
                strong [text "Error: "];
          ...
          section [
            ...
            MyDesign.stack ~spacing:MyDesign.spacing_md [
              div [
                p [text "25% Complete"];
                MyDesign.progress ~value:25 ();
              ];
              div [
                p [text "75% Complete"];
                MyDesign.progress ~value:75 ();
              ];
              div [
                p [text "100% Complete"];
                MyDesign.progress ~value:100 ();
              ];
            ];
          ];
