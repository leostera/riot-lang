                ...
                Data.Json.array
                  [ Data.Json.obj
                      [
                        ...
                        (
                          "artifact_url",
                          Data.Json.string "https://cdn.pkgs.ml/ocaml/ocaml-5.5.0-riot.4-aarch64-apple-darwin.tar.gz"
                        );
                        (
                          "checksum_url",
                          Data.Json.string "https://cdn.pkgs.ml/ocaml/ocaml-5.5.0-riot.4-aarch64-apple-darwin.tar.gz.sha256"
                        );
                      ...
                      [
                        ...
                        (
                          "artifact",
                          Data.Json.string "ocaml-5.5.0-riot.4-aarch64-apple-darwin-x-x86_64-unknown-linux-gnu.tar.gz"
                        );
                        (
                          "artifact_url",
                          Data.Json.string "https://cdn.pkgs.ml/ocaml/ocaml-5.5.0-riot.4-aarch64-apple-darwin-x-x86_64-unknown-linux-gnu.tar.gz"
                        );
                        (
                          "checksum_url",
                          Data.Json.string "https://cdn.pkgs.ml/ocaml/ocaml-5.5.0-riot.4-aarch64-apple-darwin-x-x86_64-unknown-linux-gnu.tar.gz.sha256"
                        );
