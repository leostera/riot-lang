...
(** The separator used for namespacing modules, e.g., "__" *)
...
type entry = {
  ...
  namespaced : string list;
      (** Fully namespaced name parts, e.g., ["Tusk"; "Core"; "Build_node"] *)
...
val make_namespaced : t -> string -> string list
...
val find_by_namespaced : t -> string list -> entry list
