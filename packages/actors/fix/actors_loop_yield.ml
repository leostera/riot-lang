...
let explanation =
  Api.Explanation.{
    ...
    message = "Actors while and for loops should yield immediately.";
    body =
      {|
Long-running loops inside `actors` need to cooperate with the scheduler explicitly.
