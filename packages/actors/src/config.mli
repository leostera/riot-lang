(** Runtime configuration for Actors *)
type timer_resolution =
  | Second
  (** Timer resolution in seconds - lowest overhead *)
  | Millisecond
  (** Timer resolution in milliseconds - balanced *)
  | Microsecond
  (** Timer resolution in microseconds - high precision *)
  | Nanosecond
(** Timer resolution in nanoseconds - highest precision *)
type t = {
