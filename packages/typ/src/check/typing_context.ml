...
type function_type = { label: arg_label; parameter: type_expr; result: type_expr }
...
and alias_type = { type_: type_expr; id: int }
...
and poly_variant_bound_serializer =
  Serde.Ser.variant
    [
      Serde.Ser.Variant.unit
        "Exact"
            ...
            Serde.Ser.fields
              [
                ...
                Serde.Ser.field
                  ...
                  (Serde.Ser.contramap
                    Array.from_list
                    (Serde.Ser.array poly_variant_field_serializer))
