...
let arrow_label_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
...
let rec type_expr_serializer = {
  Serde.Ser.run =
    fun backend state value ->
      let type_constr_serializer = Serde.Ser.record
        (Serde.Ser.fields
          [
            Serde.Ser.field
              "path"
      ...
      let type_poly_serializer = Serde.Ser.record
        (Serde.Ser.fields
          [
            Serde.Ser.field
              "binders"
      ...
      let type_arrow_serializer = Serde.Ser.record
        (Serde.Ser.fields
          [
            Serde.Ser.field
              "label"
              (Serde.Ser.option arrow_label_serializer)
...
let module_definition_serializer = Serde.Ser.variant
...
let include_target_serializer = Serde.Ser.variant
...
let exception_rhs_serializer = Serde.Ser.variant
...
let value_declaration_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "id"
        binding_id_serializer
      ...
      Serde.Ser.field
        "name"
        (Serde.Ser.option Serde.Ser.string)
...
let module_declaration_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "id"
      ...
      Serde.Ser.field
        "definition"
        module_definition_serializer
        (fun (value: Semantic_tree.module_declaration) -> value.definition);
    ])

let module_type_declaration_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "id"
...
let open_statement_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "span"
      ...
      Serde.Ser.field
        "target"
        (Serde.Ser.option path_serializer)
...
let include_statement_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "span"
      ...
      Serde.Ser.field
        "target"
        include_target_serializer
        (fun (value: Semantic_tree.include_statement) -> value.target);
    ])

let exception_declaration_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "id"
      ...
      Serde.Ser.field
        "rhs"
        (Serde.Ser.option exception_rhs_serializer)
        (fun (value: Semantic_tree.exception_declaration) -> value.rhs);
    ])

let external_declaration_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "id"
...
let expression_item_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "span"
...
let unsupported_item_serializer = Serde.Ser.record
  (Serde.Ser.fields
    [
      Serde.Ser.field
        "span"
...
let item_serializer = Serde.Ser.variant
  [
