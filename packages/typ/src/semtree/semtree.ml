  ...
  Serde.Ser.variant
    [
      ...
      Serde.Ser.Variant.newtype
        ...
        module_type_declaration_serializer
        (
          function
      ...
      Serde.Ser.Variant.newtype
        ...
        exception_declaration_serializer
        (
          function
      ...
      Serde.Ser.Variant.newtype
        "ExternalDeclaration"
        external_declaration_serializer
        (
          function
