...
val with_local_level_gen: t -> variance_of_named:(TypeRepr.named_type_head -> TypeRepr.t list -> TypeDecl.variance list) -> (unit -> 'a * generalization_group list) -> 'a * TypeScheme.t list list
