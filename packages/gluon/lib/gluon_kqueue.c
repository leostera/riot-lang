...
/* Bytecode version with different calling convention */
CAMLprim value gluon_kevent_bytecode(value *argv, int argn) {
    return gluon_kevent(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);
}
