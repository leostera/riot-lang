...
type request_id = String of string | Number of int  (** JSON-RPC request ID *)
...
val make_request :
  ?params:request_params -> request_id -> request_method -> request
...
val make_notification :
  ?params:notification_params -> notification_method -> notification
