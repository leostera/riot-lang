...
let notification_method_to_string =
  function
...
let string_to_notification_method =
  function
...
(** JSON Serialization *)
let request_id_to_json =
  function
  | String s -> Json.String s
  | Number n -> Json.Int n

let request_id_of_json =
  function
