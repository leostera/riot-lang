...
6. `Riot_init.new_package` owns package scaffolding inside an existing workspace. It should accept typed `Path.t` inputs, not raw strings, and it should not route through `riot-build`.
