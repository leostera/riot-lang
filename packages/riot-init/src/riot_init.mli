...
val new_package: workspace:Riot_model.Workspace_manifest.t -> path:Path.t -> name:string -> is_library:bool -> ((string * string), string) result

val new_standalone_package: path:Path.t -> name:string -> is_library:bool -> ((string * string), string) result
