...
module For_test : sig
  ...
  val publish_with: ?on_event:(publish_event -> unit) -> deps:deps -> workspace:Riot_model.Workspace.t -> request:publish_request -> mode:publish_mode -> unit -> (publish_outcome list, publish_error) result
end

val publish: ?on_event:(publish_event -> unit) -> workspace:Riot_model.Workspace.t -> request:publish_request -> mode:publish_mode -> unit -> (publish_outcome list, publish_error) result
