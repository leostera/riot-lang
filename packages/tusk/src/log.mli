...
val create_session : unit -> session_id
...
val build_started : ?sid:session_id -> packages:string list -> total_modules:int -> workers:int -> unit
val build_complete : ?sid:session_id -> duration_ms:int -> results:build_result list -> unit
...
val compiling_implementation : ?sid:session_id -> package:string -> file:string -> unit
val linking_library : ?sid:session_id -> package:string -> output:string -> unit
val linking_executable : ?sid:session_id -> package:string -> output:string -> unit
...
val event_to_json : log_event -> Json.t
