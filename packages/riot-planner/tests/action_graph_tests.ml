...
let dependency_output_names_flat = fun graph (node: Riot_planner.Action_node.t) ->
  ...
  |> List.map
    ~fn:(fun (dep_node: Riot_planner.Action_node.t) ->
      List.map dep_node.value.outs ~fn:Path.to_string)
  |> List.concat
  ...
  match Fs.with_tempdir
    ...
    (fun tmpdir ->
      ...
      | Ok (_package, actions) ->
          ...
          | (Some (Riot_planner.Action.CreateLibrary { objects = library_objects; _ }), Some (
  ...
  match Fs.with_tempdir
    ...
    (fun tmpdir ->
      ...
      | Ok (_package, actions) ->
          ...
          | (Some (Riot_planner.Action.CreateLibrary { objects = library_objects; _ }), Some (
            Riot_planner.Action.CreateExecutable { objects = binary_objects; _ }
  ...
  match Fs.with_tempdir
    ...
    (fun tmpdir ->
      ...
      | Ok (_package, actions) ->
          ...
          | (None, Some (Riot_planner.Action.CreateExecutable { objects = main_objects; _ }), Some (
            Riot_planner.Action.CreateExecutable { objects = tool_objects; _ }
  ...
  match Fs.with_tempdir
    ...
    (fun tmpdir ->
      ...
      | Ok (_package, actions) ->
          ...
          | (Some (Riot_planner.Action.CreateExecutable { objects = main_objects; _ }), Some (
            Riot_planner.Action.CreateExecutable { objects = tool_objects; _ }
