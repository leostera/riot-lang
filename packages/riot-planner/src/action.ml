...
let from_json = fun json ->
  let open Data.Json in
    ...
    | Some (String "CompileInterface") -> (
        match get_field "source" json, parse_path_list "outputs" json, parse_path_list "includes" json, parse_flags
          json with
    ...
    | Some (String "CreateLibrary") -> (
        match parse_path_list "outputs" json, parse_path_list "objects" json, parse_path_list
          "includes"
          json with
    ...
    | Some (String "CreateExecutable") -> (
        match parse_path_list "outputs" json, parse_path_list "objects" json, parse_path_list
          "libraries"
          json, parse_path_list "includes" json, parse_path_list "cclibs" json, parse_string_list
          "ccopt_flags"
          json, parse_string_list "cclib_flags" json with
    ...
    | Some (String "BuildForeignDependency") -> (
        ...
        let parse_env json =
          ...
          | _ -> []
        in
        match get_field "name" json, get_field "path" json, parse_build_cmd json, parse_path_list
          "outputs"
          json with
