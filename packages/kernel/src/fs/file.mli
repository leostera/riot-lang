...
val readdir_handle :
  Unix.dir_handle -> (string, [> Async.io_error ]) Async.io_result
...
val open_file :
  ...
  open_flag list ->
  int ->
  (Unix.file_descr, [> Async.io_error ]) Async.io_result
...
val lseek :
  ...
  int64 ->
  seek_command ->
  (int64, [> Async.io_error ]) Async.io_result

val ftruncate :
  Unix.file_descr -> int64 -> (unit, [> Async.io_error ]) Async.io_result

val fchmod :
  Unix.file_descr -> int -> (unit, [> Async.io_error ]) Async.io_result

val fsync : Unix.file_descr -> (unit, [> Async.io_error ]) Async.io_result

val dup :
  Unix.file_descr -> (Unix.file_descr, [> Async.io_error ]) Async.io_result

val lockf :
  Unix.file_descr ->
  lock_command ->
  int ->
  (unit, [> Async.io_error ]) Async.io_result
