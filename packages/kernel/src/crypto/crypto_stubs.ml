...
external sha1_iovec_bytes: Iovec.t -> bytes = "kernel_crypto_sha1_iovec"

external sha256_bytes: bytes -> bytes = "kernel_crypto_sha256"

external sha256_iovec_bytes: Iovec.t -> bytes = "kernel_crypto_sha256_iovec"

external sha512_bytes: bytes -> bytes = "kernel_crypto_sha512"

external sha512_iovec_bytes: Iovec.t -> bytes = "kernel_crypto_sha512_iovec"

external md5_bytes: bytes -> bytes = "kernel_crypto_md5"

external md5_iovec_bytes: Iovec.t -> bytes = "kernel_crypto_md5_iovec"

external simple_hash_bytes: bytes -> bytes = "kernel_crypto_simple_hash"

external simple_hash_iovec_bytes: Iovec.t -> bytes = "kernel_crypto_simple_hash_iovec"
...
let sha1_iovec = sha1_iovec_bytes

let sha256 = fun data ->
  let bytes = Bytes.unsafe_of_string data in
  sha256_bytes bytes

let sha256_iovec = sha256_iovec_bytes

let sha512 = fun data ->
  let bytes = Bytes.unsafe_of_string data in
  sha512_bytes bytes

let sha512_iovec = sha512_iovec_bytes

let md5 = fun data ->
  let bytes = Bytes.unsafe_of_string data in
  md5_bytes bytes

let md5_iovec = md5_iovec_bytes

let default_hash = fun data ->
  let bytes = Bytes.unsafe_of_string data in
  simple_hash_bytes bytes

let default_hash_iovec = simple_hash_iovec_bytes
