...
val get_constraint: t -> package -> [
    `Decided of version
    | `Constrained of version Ranges.t
    | `Undecided
  ]
...
val pick_highest_priority_pkg:
  t -> (package -> version Ranges.t -> int) -> (package * version Ranges.t) option

val current_decision_level: t -> decision_level

val backtrack: t -> decision_level -> t

val relation: t -> Incompatibility.t -> [
    `Satisfied
