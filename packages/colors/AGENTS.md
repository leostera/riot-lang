...
3. Keep invalid-input behavior explicit and stable: ANSI indices and blend mix are clamped, while custom white references must be finite and have positive `Y`.
