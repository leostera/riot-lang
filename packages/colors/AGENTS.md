...
3. Keep invalid-input behavior explicit and stable: ANSI indices and blend mix are clamped, `ANSI.nearest` clamps RGB channels and breaks ties toward the lowest index, while custom white references must be finite and have positive `Y`.
