...
let runtime_phase_fields = function
  | TargetsResolved { target_count } | ToolchainsEnsured { target_count } | ToolchainsValidated { target_count } ->
      [
        "target_count", Data.Json.Int target_count;
      ]
  | PackagePlanningStarted { lane_count; package_count } | PackageExecutionStarted { lane_count; package_count } ->
      [
        "lane_count", Data.Json.Int lane_count;
        "package_count", Data.Json.Int package_count;
      ]
  | PackagePlanningFinished { lane_count; package_count; deferred_count; execution_required_count; finalized_count; cached_count; skipped_count; failed_count; error_count } ->
      [
        "lane_count", Data.Json.Int lane_count;
        "package_count", Data.Json.Int package_count;
  ...
  | PackageExecutionFinished { lane_count; package_count; finalized_count; built_count; failed_count; error_count } ->
      [
        "lane_count", Data.Json.Int lane_count;
        "package_count", Data.Json.Int package_count;
        "finalized_count", Data.Json.Int finalized_count;
  ...
  | CacheGenerationRecordingStarted { lane_count; new_entry_count } | CacheGenerationRecorded { lane_count; new_entry_count } ->
      [
        "lane_count", Data.Json.Int lane_count;
