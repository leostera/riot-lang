...
val execute_raw: ?allow_partial_failures:bool -> ?record_cache_generation:bool -> Build_context.t -> Resolved_build.t -> (Package_builder.build_result list, error) result
