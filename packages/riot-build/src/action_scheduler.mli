...
val summarize_completed: action_graph:Action_graph.t -> completed_results:(Graph.SimpleGraph.Node_id.t, execution_result) HashMap.t -> t

val run: action_graph:Action_graph.t -> sandbox:Sandbox.t -> store:Riot_store.Store.t -> session_id:Riot_model.Session_id.t -> Riot_toolchain.t -> concurrency:int -> t
