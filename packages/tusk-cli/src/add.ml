...
type error =
  ...
  | AddFailed of Tusk_deps.package_error
...
let command =
  let open ArgParser in
    ...
    |> about "Add a dependency to a manifest and refresh tusk.lock"
    |> args
      [
        ...
        flag "dev" |> long "dev" |> help "Add to [dev-dependencies]";
...
let message = function
  ...
  | AddFailed error -> Tusk_deps.package_error_message error
