...
*)
val send_headers: t -> stream_id:int -> headers:Hpack.header list -> end_stream:bool -> (string, string) Result.t
...
(**
   ...
   @return Bytes to send
*)
val send_goaway: t -> last_stream_id:int -> error_code:Frame.error_code -> ?debug_data:string -> unit -> string
