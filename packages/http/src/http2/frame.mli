...
val headers: stream_id:stream_id -> ?end_stream:bool -> ?end_headers:bool -> ?pad_length:int -> ?priority:int * bool * int -> string -> t
...
val int_to_error_code: int -> error_code option(** Convert integer to error code *)
