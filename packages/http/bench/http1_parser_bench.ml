...
let benchmarks = Bench.[
  with_config ~config:{ iterations = 200; warmup = 20 } "http1 parser in-memory baseline string: small request" (bench_parse_baseline small_request);
  with_config ~config:{ iterations = 150; warmup = 15 } "http1 parser in-memory baseline string: 1 KiB body" (bench_parse_baseline request_1k);
  with_config ~config:{ iterations = 60; warmup = 6 } "http1 parser in-memory baseline string: 100 KiB body" (bench_parse_baseline request_100k);
  with_config ~config:{ iterations = 15; warmup = 3 } "http1 parser in-memory baseline string: 1 MiB body" (bench_parse_baseline request_1m);
  with_config ~config:{ iterations = 5; warmup = 1 } "http1 parser in-memory baseline string: 10 MiB body" (bench_parse_baseline request_10m);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory baseline string: many headers" (bench_parse_baseline many_headers_request);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory baseline string: github navigation request" (bench_parse_baseline github_navigation_request);
  ...
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory: github navigation request" (bench_parse github_navigation_request);
  with_config ~config:{ iterations = 200; warmup = 20 } "http1 parser in-memory slice: small request" (bench_parse_slice small_request_slice);
  with_config ~config:{ iterations = 150; warmup = 15 } "http1 parser in-memory slice: 1 KiB body" (bench_parse_slice request_1k_slice);
  with_config ~config:{ iterations = 60; warmup = 6 } "http1 parser in-memory slice: 100 KiB body" (bench_parse_slice request_100k_slice);
  with_config ~config:{ iterations = 15; warmup = 3 } "http1 parser in-memory slice: 1 MiB body" (bench_parse_slice request_1m_slice);
  with_config ~config:{ iterations = 5; warmup = 1 } "http1 parser in-memory slice: 10 MiB body" (bench_parse_slice request_10m_slice);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory slice: many headers" (bench_parse_slice many_headers_request_slice);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory slice: github navigation request" (bench_parse_slice github_navigation_request_slice);
  with_config ~config:{ iterations = 200; warmup = 20 } "http1 parser in-memory borrowed slice: small request" (bench_parse_borrowed small_request_slice);
  with_config ~config:{ iterations = 150; warmup = 15 } "http1 parser in-memory borrowed slice: 1 KiB body" (bench_parse_borrowed request_1k_slice);
  with_config ~config:{ iterations = 60; warmup = 6 } "http1 parser in-memory borrowed slice: 100 KiB body" (bench_parse_borrowed request_100k_slice);
  with_config ~config:{ iterations = 15; warmup = 3 } "http1 parser in-memory borrowed slice: 1 MiB body" (bench_parse_borrowed request_1m_slice);
  with_config ~config:{ iterations = 5; warmup = 1 } "http1 parser in-memory borrowed slice: 10 MiB body" (bench_parse_borrowed request_10m_slice);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory borrowed slice: many headers" (bench_parse_borrowed many_headers_request_slice);
  with_config ~config:{ iterations = 120; warmup = 12 } "http1 parser in-memory borrowed slice: github navigation request" (bench_parse_borrowed github_navigation_request_slice);
]
