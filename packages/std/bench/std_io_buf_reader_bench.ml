...
let benchmarks =
    ...
    List.map
      ...
      ~fn:(fun fixture ->
        Bench.compare_with_config
          ...
          ("std io buf reader lines: " ^ fixture.name)
          [
            Bench.make_case
              "read_line"
              (fun () ->
  ...
  let rune_benchmarks = [
    Bench.compare_with_config
      ...
      "std io buf reader codepoints: 8192 mixed UTF-8 runes"
      [
        Bench.make_case
          "read_byte"
          (fun () ->
    ...
    Bench.compare_with_config
      ~config:{ iterations = 60; warmup = 6 }
      "std io buf reader scanner: 48 KiB ascii bytes"
      [
        Bench.make_case
          "read_byte"
          (fun () ->
