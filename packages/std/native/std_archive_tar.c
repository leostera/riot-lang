...
CAMLprim value std_tar_create_reader(value v_unit) {
    CAMLparam1(v_unit);
    CAMLlocal1(v_reader);
...
CAMLprim value std_tar_feed_reader(value v_reader, value v_src, value v_src_pos, value v_src_len) {
...
CAMLprim value std_tar_next_entry(value v_reader) {
    CAMLparam1(v_reader);
...
CAMLprim value std_tar_read_entry_data(value v_reader, value v_dst, value v_dst_pos, value v_dst_len) {
...
CAMLprim value std_tar_skip_entry(value v_reader) {
    CAMLparam1(v_reader);
    CAMLlocal1(result);
...
CAMLprim value std_tar_close_reader(value v_reader) {
    CAMLparam1(v_reader);
