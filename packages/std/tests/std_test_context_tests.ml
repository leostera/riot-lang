...
let test_ctx_includes_suite_and_test_name =
  Test.case "ctx includes suite and test name"
    (
      fun ctx ->
...
let test_ctx_assigns_one_based_indices =
  Test.case "ctx assigns one-based indices"
    (
      fun ctx ->
