...
let tests =
  Test.[
    ...
    case
      "set_unchecked mutates without returning a result"
      test_set_unchecked_mutates_without_result;
    case "blit copies full slices" test_blit_full_copy_copies_source_into_destination;
    case
      "blit handles overlapping right shifts"
      test_blit_overlapping_right_shift_matches_bytes_semantics;
    case
      "blit handles overlapping left shifts"
      test_blit_overlapping_left_shift_matches_bytes_semantics;
    ...
    case
      "multiple mutations preserve final contents"
      test_multiple_mutations_preserve_final_contents;
  ]
