...
let tests = Test.[ case "IO.stdin treats empty iovecs as a no-op" test_stdin_reader_empty_iovec_is_a_noop; case "IO.stdout handles empty writer operations" test_stdout_writer_handles_empty_operations; case "IO.stderr handles empty writer operations" test_stderr_writer_handles_empty_operations ]
