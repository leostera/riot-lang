...
let finish = fun state -> Common.finish_iovec Ffi.sha1_iovec state

let hash_string = Common.hash_string_with Ffi.sha1_iovec

let hash_bytes = Common.hash_bytes_with Ffi.sha1_iovec
