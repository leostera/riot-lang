(** # Digest - Hash digest formatting
    ...
    Convert cryptographic hash values to various output formats for
    different use cases.
    ...
    (* Hexadecimal - for display and logging *)
    let hex = Crypto.Digest.hex hash in
    (* "315f5bdb76d078c43b8ac0064e4a0164612b1fce77c869345bfc94c75894edd3" *)

    (* Base64 - compact representation *)
    let b64 = Crypto.Digest.base64 hash in
    (* "MV9b23bQeMQ7isAGTkoJZGErH8534ocpRb/JTHWJTt0=" *)

    (* URL-safe Base64 - for URLs and filenames *)
    let b64url = Crypto.Digest.base64_url hash in
    (* "MV9b23bQeMQ7isAGTkoJZGErH8534ocpRb_JTHWJTt0=" *)

    (* Integer - for hash table indexing *)
    let idx = Crypto.Digest.to_int hash
    ```
