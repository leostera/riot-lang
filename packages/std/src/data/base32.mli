(** # Data.Base32 - Base32 encoding and decoding
    ...
    characters (A-Z, 2-7). More compact than Base16 but less efficient 
    than Base64. Uses RFC 4648 standard encoding.
...
(** Encodes a string to Base32.
    ...
    ```ocaml
    Base32.encode "Hi"  (* "JBQQ====" *)
    Base32.encode "test"  (* "ORSXG5A=" *)
    ```
*)
...
(** Decodes a Base32 string. Case-insensitive.
    ...
    ```ocaml
    Base32.decode "JBSWY3DP"  (* Ok "Hello" *)
    Base32.decode "jbswy3dp"  (* Ok "Hello" - lowercase works *)
    Base32.decode "JBSWY3DP===="  (* Ok "Hello" - padding optional *)
    Base32.decode "!!!!"  (* Error `Invalid_base32 *)
    ```
