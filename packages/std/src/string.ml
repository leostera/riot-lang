...
let into_mut_iter = fun source -> MutIterator.make (module MutIter) { source; current_pos = 0 }
...
let into_iter = fun source -> Iterator.make (module Iter) { source; current_pos = 0 }
