...
let is_upper = fun r -> Unicode_tables.in_table Unicode_tables._lu (to_int r)

let is_lower = fun r -> Unicode_tables.in_table Unicode_tables._ll (to_int r)

let is_title = fun r -> Unicode_tables.in_table Unicode_tables._lt (to_int r)

let is_digit = fun r -> Unicode_tables.in_table Unicode_tables._nd (to_int r)

let is_number = fun r -> Unicode_tables.in_table Unicode_tables._n (to_int r)

let is_space = fun r -> Unicode_tables.in_table Unicode_tables._zs (to_int r)

let is_punct = fun r -> Unicode_tables.in_table Unicode_tables._p (to_int r)

let is_symbol = fun r -> Unicode_tables.in_table Unicode_tables._s (to_int r)

let is_mark = fun r -> Unicode_tables.in_table Unicode_tables._m (to_int r)

let is_control = fun r -> Unicode_tables.in_table Unicode_tables._cc (to_int r)
