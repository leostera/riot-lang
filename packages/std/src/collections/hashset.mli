...
type 'a t
(** The type of hash sets containing elements of type ['a]. Elements are
    stored in an unordered fashion with uniqueness guaranteed by hashing. *)
...
(** Creates a new empty hash set with specified initial capacity.
    ...
    ```ocaml
    let set = HashSet.with_capacity 1000 in
    (* Can insert ~1000 elements without rehashing *)
    ```
*)

val of_list : 'a list -> 'a t
(** Creates a hash set from a list of elements. Duplicate elements in the
    input list are automatically deduplicated.
    
    ## Examples
    
    ```ocaml
    let set = HashSet.of_list [1; 2; 2; 3; 3; 3] in
    HashSet.len set  (* 3 - duplicates removed *)
    HashSet.to_list set  (* [1; 2; 3] - order unspecified *)
    ```
*)
...
(** Adds a value to the set. Returns [true] if the value was newly inserted,
    ...
    ```ocaml
    let set = HashSet.create () in
    HashSet.insert set "new"  (* true - newly added *)
    HashSet.insert set "new"  (* false - already exists *)
    ```
...
(** Removes a value from the set. Returns [true] if the value was present
    and removed, [false] if it wasn't in the set.
    
    ## Examples
    
    ```ocaml
    let set = HashSet.of_list [1; 2; 3] in
    HashSet.remove set 2  (* true *)
...
(** Returns [true] if the value exists in the set.
    ...
    ```ocaml
    let set = HashSet.of_list ["a"; "b"; "c"] in
    HashSet.contains set "b"  (* true *)
    HashSet.contains set "z"  (* false *)
    ```
...
(** Returns [true] if the set contains no elements.
    ...
    HashSet.insert set 1 |> ignore;
    HashSet.is_empty set  (* false *)
    ```
...
(** Applies function [f] to each element in the set. The iteration order
    is unspecified and may change between runs.
    
    ## Examples
    
    ```ocaml
    let set = HashSet.of_list [1; 2; 3] in
    HashSet.iter (fun x -> Printf.printf "%d " x) set
    (* Prints: 1 2 3 (order not guaranteed) *)
    ```
...
(** Folds over all elements in the set. The iteration order is unspecified.
    ...
    ```ocaml
    let set = HashSet.of_list [1; 2; 3; 4] in
    let sum = HashSet.fold (fun x acc -> x + acc) set 0 in
    (* sum = 10 *)
    ```
...
(** Converts the set to a list. The order of elements is unspecified.
    ...
    ```ocaml
    let set = HashSet.of_list [3; 1; 2] in
    HashSet.to_list set  (* [1; 2; 3] or any permutation *)
    ```
...
(** Returns a new set containing all elements from both sets.
    ...
    ```ocaml
    let set1 = HashSet.of_list [1; 2; 3] in
    let set2 = HashSet.of_list [3; 4; 5] in
    let u = HashSet.union set1 set2 in
    HashSet.to_list u |> List.sort compare  (* [1; 2; 3; 4; 5] *)
    ```
...
(** Returns a new set containing only elements present in both sets.
    ...
    let set1 = HashSet.of_list [1; 2; 3; 4] in
    let set2 = HashSet.of_list [3; 4; 5; 6] in
    let i = HashSet.intersection set1 set2 in
...
(** Returns a new set containing elements in [set1] but not in [set2].
    ...
    let set1 = HashSet.of_list [1; 2; 3; 4] in
    let set2 = HashSet.of_list [3; 4; 5] in
    let d = HashSet.difference set1 set2 in
...
(** Returns a new set containing elements in either set, but not both.
    ...
    ```ocaml
    let set1 = HashSet.of_list [1; 2; 3] in
    let set2 = HashSet.of_list [2; 3; 4] in
    let s = HashSet.symmetric_difference set1 set2 in
...
(** Returns [true] if all elements of [set1] are in [set2].
    ...
    ```ocaml
    let set1 = HashSet.of_list [1; 2] in
    let set2 = HashSet.of_list [1; 2; 3; 4] in
    HashSet.is_subset set1 set2  (* true *)
    HashSet.is_subset set2 set1  (* false *)
    ```
...
(** Returns [true] if [set1] contains all elements of [set2].
    ...
    ```ocaml
    let set1 = HashSet.of_list [1; 2; 3; 4] in
    let set2 = HashSet.of_list [2; 3] in
    HashSet.is_superset set1 set2  (* true *)
    ```
...
(** Returns [true] if the sets have no common elements.
    ...
    ```ocaml
    let set1 = HashSet.of_list [1; 2; 3] in
    let set2 = HashSet.of_list [4; 5; 6] in
    let set3 = HashSet.of_list [3; 4; 5] in
    
    HashSet.is_disjoint set1 set2  (* true *)
    HashSet.is_disjoint set1 set3  (* false - share 3 *)
    ```
