(** # Collections - Data structure modules
    ...
    Collection data structures for efficient data storage and manipulation.
    All modules provide ergonomic APIs with good performance characteristics.
    ...
    let set = HashSet.of_list [1; 2; 3; 2; 1] in
    ...
    Queue.dequeue queue  (* Some "task1" *)
    ```
