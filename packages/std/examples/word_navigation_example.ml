...
let () =
  ...
  println ("   Words: [" ^ String.concat "; " (List.map (fun w -> "\"" ^ w ^ "\"") words2) ^ "]\n");
  ...
  println ("   Words: [" ^ String.concat "; " (List.map (fun w -> "\"" ^ w ^ "\"") words3) ^ "]\n");
  ...
  println ("   Words: [" ^ String.concat "; " (List.map (fun w -> "\"" ^ w ^ "\"") words4) ^ "]\n");
  ...
  println ("   Words: [" ^ String.concat "; " (List.map (fun w -> "\"" ^ w ^ "\"") words5) ^ "]");
  ...
  println ("   Words: [" ^ String.concat "; " (List.map (fun w -> "\"" ^ w ^ "\"") words6) ^ "]\n");
