...
(** Execute an action graph linearly (sequentially without caching).
    
    Similar to action_executor but with more detailed logging.
    ...
    @param concurrency Ignored (linear execution)
