...
type run_error =
  ...
  | ClientError of Client.error
val build_scope_for_binary: Tusk_model.Workspace.t -> package_name:string -> binary_name:string -> build_scope
...
type test_error =
  ...
  | SuitesFailed of int
val collect_test_suites: Tusk_model.Workspace.t -> ?package_filter:string -> unit -> suite_binary list
...
type bench_error =
  ...
  | SuiteExecutionError of { suite: suite_binary; reason: string }
  | SuitesFailed of int
val collect_bench_suites: Tusk_model.Workspace.t -> ?package_filter:string -> unit -> suite_binary list
