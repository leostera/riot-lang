...
let tests = [
  Test.case "failed save_object cleans immutable temp files" test_failed_save_object_cleans_immutable_temp_files;
  Test.case "failed save_named_object cleans mutable temp files" test_failed_save_named_object_cleans_mutable_temp_files;
