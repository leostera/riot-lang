...
let tests = [
  Test.property
    ...
    ~examples
    (fun _ctx ->
      assert_property "save_named_object keeps last writer" named_objects_keep_last_writer);
  Test.property
    "save_named_object/open_named_object roundtrip"
    ~size:Large
    ~examples
    (fun _ctx ->
      assert_property "save_named_object/open_named_object roundtrip" save_named_object_roundtrip);
  Test.property
