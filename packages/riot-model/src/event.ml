      ...
      | Some (Json.String event_name) -> (
          ...
          | "riot.pm.resolution.finished" -> (
              ...
              | Json.Object data_fields -> (
                  ...
                  | (Some (Json.Int duration_ms), Some (Json.Int resolved_packages), Some (
                    Json.Int resolved_edges
                  )) ->
          ...
          | "riot.pm.universe.built" -> (
              ...
              | Json.Object data_fields -> (
                  ...
                  | (Some (Json.Int runtime_packages), Some (Json.Int build_packages), Some (
                    Json.Int dev_packages
          ...
          | "riot.pm.manifest.updated" -> (
              ...
              | Json.Object data_fields -> (
                  ...
                  | (Some (Json.String path), Some (Json.String section), Some operation_json, Some (
                    Json.String dependency
                  )) -> (
          ...
          | "riot.pm.package.updated" -> (
              ...
              | Json.Object data_fields -> (
                  ...
                  | (Some package_json, Some (Json.String from_version), Some (
                    Json.String to_version
                  )) ->
                      let* package = package_name_of_json package_json in
          ...
          | "riot.pm.package_download.finished" -> (
              ...
              | Json.Object data_fields -> (
                  ...
                  | (Some package_json, Some (Json.String version), Some (Json.String path), Some (
