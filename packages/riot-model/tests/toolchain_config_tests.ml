...
let tests =
  Test.[
    case
      "Toolchain_config.from_root defaults without ocaml-toolchain.toml"
      test_from_workspace_defaults_without_toolchain_file;
    case
      "Toolchain_config.from_root parses and normalizes typed targets"
      test_from_workspace_parses_and_normalizes_targets;
    case
      "Toolchain_config.from_root parses local path sources"
