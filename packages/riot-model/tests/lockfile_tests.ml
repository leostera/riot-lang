...
|}
  ...
  | Error err -> Error ("expected minimal lockfile to decode, got: "
...
|}
  ...
  | Error err -> Error ("expected missing dependency_hash, got: "
  ^ Riot_model.Lockfile.error_message err)
...
|}
  ...
  | Error err -> Error ("expected invalid dependency package name, got: "
  ^ Riot_model.Lockfile.error_message err)
...
|}
  ...
  | Error err -> Error ("expected unknown provenance kind, got: "
  ^ Riot_model.Lockfile.error_message err)
