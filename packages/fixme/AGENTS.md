...
4. Keep rule ids lightweight, but use `Rule_id.t` instead of raw strings across the shared rule-authoring surface; do not reintroduce a built-in diagnostic-code registry here.
