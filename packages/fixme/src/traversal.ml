...
let rec let_bindings_of_module_expression =
  function
...
and let_bindings_of_object_member =
  function
...
and let_bindings_of_function_body =
  function
...
and let_bindings_of_apply_argument =
  function
...
and let_bindings_of_class_expression =
  function
...
let let_bindings_of_structure_item =
  function
  ...
  | Syn.Cst.StructureItem.ModuleDeclaration decl ->
      let rec let_bindings_of_module_structure = fun decl ->
...
let rec expressions_of_expression = fun expr ->
  ...
  in
  expr :: nested
and expressions_of_function_body =
  function
...
and expressions_of_apply_argument =
  function
...
let expressions_of_structure_item =
  function
  | Syn.Cst.StructureItem.TypeDeclaration _
  | Syn.Cst.StructureItem.TypeExtension _
