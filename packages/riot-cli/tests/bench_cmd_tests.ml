...
let tests = [
  Test.case
    "bench renderer: relative speed line includes fastest case and ratio"
    test_render_relative_speed_line_mentions_fastest_ratio_and_slower_case;
  Test.case
    "bench renderer: slower comparison case label stays plain"
    test_comparison_case_label_leaves_slower_case_plain;
  Test.case
    "bench renderer: fastest comparison case label mentions the fastest case"
    test_comparison_case_label_mentions_fastest_case;
]
