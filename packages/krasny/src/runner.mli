...
val run_checks_streaming: ?concurrency:int -> ?should_ignore:(Path.t -> bool) -> roots:Path.t list -> on_result:(file_result -> unit) -> unit -> run_result

val run_verify_streaming: ?concurrency:int -> ?should_ignore:(Path.t -> bool) -> roots:Path.t list -> on_result:(file_result -> unit) -> unit -> run_result

val run_format_streaming: ?concurrency:int -> ?should_ignore:(Path.t -> bool) -> roots:Path.t list -> on_result:(file_result -> unit) -> unit -> run_result
