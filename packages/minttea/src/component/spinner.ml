...
let dot = fun () -> Sprite.make
[|"⣾ "; "⣽ "; "⣻ "; "⢿ "; "⡿ "; "⣟ "; "⣯ "; "⣷ "|]
~fps:(Fps.of_int 10)

let mini_dot = fun () -> Sprite.make
[|"⠋"; "⠙"; "⠹"; "⠸"; "⠼"; "⠴"; "⠦"; "⠧"; "⠇"; "⠏"|]
~fps:(Fps.of_int 12)

let jump = fun () -> Sprite.make
[|"⢄"; "⢂"; "⢁"; "⡁"; "⡈"; "⡐"; "⡠"|]
~fps:(Fps.of_int 10)

let pulse = fun () -> Sprite.make [|"█"; "▓"; "▒"; "░"|] ~fps:(Fps.of_int 8)

let points = fun () -> Sprite.make
[|"∙∙∙"; "●∙∙"; "∙●∙"; "∙∙●"|]
~fps:(Fps.of_int 7)

let meter = fun () -> Sprite.make
[|"▱▱▱"; "▰▱▱"; "▰▰▱"; "▰▰▰"; "▰▰▱"; "▰▱▱"; "▱▱▱"|]
~fps:(Fps.of_int 7)

let globe = fun () -> Sprite.make [|"🌍"; "🌎"; "🌏"|] ~fps:(Fps.of_int 4)

let moon = fun () -> Sprite.make
[|"🌑"; "🌒"; "🌓"; "🌔"; "🌕"; "🌖"; "🌗"; "🌘"|]
~fps:(Fps.of_int 8)
