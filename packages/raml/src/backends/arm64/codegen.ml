  ...
  List.iteri
    (fun i arg ->
      let arg_reg =
        ...
        | 6 -> Instruction.X6
        | 7 -> Instruction.X7
        | _ -> failwith "Too many arguments (max 8 for now)"
      in
