...
*)
val make_fetch: get:(Net.Uri.t -> (fetch_response, string) result) -> ?post:(Net.Uri.t -> headers:(string * string) list -> body:string -> (fetch_response, string) result) -> unit -> fetch
...
val create_filesystem: ?fetch:fetch -> registry_name:string -> ?riot_home:Path.t -> unit -> (t, Registry_cache.create_error) result
...
val in_memory: ?config:Sparse_index.config -> cache:Registry_cache.t -> ?releases:release_source list -> packages:Sparse_index.package_document list -> unit -> t
...
val read_package_document: t -> package_name:string -> (Sparse_index.package_document option, string) result
...
val refresh_package_document: t -> package_name:string -> (Sparse_index.package_document option, string) result
...
val yank_release: t -> api_token:string -> package_name:string -> version:string -> (yanked_release, string) result
