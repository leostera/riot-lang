...
- stale rollout-era dead helpers continue to shrink during audits; unused locals such as `unwrap_parenthesized_expression`, `flatten_top_level_expression_item`, and `render_structure_expression_run` are gone from `lower.ml`.
