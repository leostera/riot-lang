...
- [ ] The next concrete slice is rebuilding nested `sig ... end` bodies as normalized item lists so nested ownership can reuse the same ordered-item model as the top level
