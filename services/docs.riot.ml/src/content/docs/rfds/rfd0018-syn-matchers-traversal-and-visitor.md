...
> Canonical source: `docs/rfds/RFD0018-syn-matchers-traversal-and-visitor.md`
...
The CST is already making rules and tools easier to write, but consumers still
repeat too much structural work:
...
That is a sign that the CST layer is useful but incomplete on its own. Riot
needs a shared support layer so syntax consumers stop rediscovering the same
shape knowledge independently.
